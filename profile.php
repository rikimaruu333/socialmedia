...
<body>
        ...
        <div class="modal-content">
            ...
            <form id="editProfileForm">
                <div class="profilebox">
                    <div class="namepicbox">
                        <div class="imgbox" id="selectedFile">
                            <img src="pics/user.jpg" alt="" class="cover">
                        </div>
                        <div class="names">
                    ...
                    <div class="buttonpicbox">
                        <button type="button" id="changeProfileBtn">Change photo</button>
                ...
                <input type="text" id="nickname" name="nickname" placeholder="Optional..."><br><br>
    ...
    <div class="postUpdateModal" id="updatePostModal">
